...
QUERY_STRING="symbol=BNBUSDT&side=BUY&type=LIMIT&timeInForce=GTC&quantity=1&price=20&recWindow=20000&timestamp=1620641702892"
...
curl -H "X-MBX-APIKEY: $2" -X POST $URL